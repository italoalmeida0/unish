...
// ToggleFirst is bash's ${parameter~}: it toggles the case of the first
// character. It reuses the tilde token rather than the sequential
// operator block above.
const ToggleFirst = ParExpOperator(tilde)
